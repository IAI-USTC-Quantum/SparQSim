...
```{note}
本页镜像仓库级指南
[docs/algorithm-implementation_zh-cn.md](https://github.com/IAI-USTC-Quantum/SparQSim/blob/main/docs/algorithm-implementation_zh-cn.md)。
该文件为权威版本；更新后请在文档站重建时刷新本副本。
```

## 基于 PySparQ 的量子算法实现

[English](https://iai-ustc-quantum.github.io/SparQSim/en/guide/algorithms/porting.html)
