# Configuration file for the Sphinx documentation builder (Chinese tree).
#
...
# Chinese documentation settings
language = "zh_CN"
html_title = "SparQ 文档"

# Per-tree source links (furo "view source" button)
html_theme_options["source_directory"] = "docs/sphinx/source/zh/"
