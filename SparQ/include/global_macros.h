 ...
 * @brief Global macro definitions file
 * @details Defines compilation configuration macros, condition control macros, CUDA support macros, and various
 *          utility macros
 */
 ...
 * @brief Check whether the condition registers are all nonzero
 */
 ...
 * @brief Check whether the condition registers are all 1 (all full)
 */
 ...
 * @brief Check condition registers by value
 */
 ...
 * @brief Check condition registers by bit
 */
...
/**
 * @def HasCondition
 * @brief Check whether any condition exists
 */
#define HasCondition (\
 ...
 * @brief Check whether all conditions are satisfied
 */
 ...
 * @brief Check whether the condition is not satisfied
 */
 ...
 * @brief Define the nonzero condition control member variables and methods
 * @details Adds the condition_variable_nonzeros member and the related condition control methods to a class
 */
 ...
 * @brief Define the all-ones condition control member variables and methods
 */
 ...
 * @brief Define the per-bit condition control member variables and methods
 * @details Allows setting condition control on specific bits
 */
 ...
 * @brief Define the per-value condition control member variables and methods
 */
 ...
 * @brief Combine all condition control macros
 */
...
/**
 * @def GetAs
 * @brief Get the register value as the specified type
 */
 ...
 * @brief Debug macro: check whether a register value overflows
 */
 ...
 * @brief Forward all condition control settings
 */
...
/**
 * @def INLINE_IMPL
 * @brief Inline implementation macro
 */
...
/**
 * @def DECLARE_IMPL
 * @brief Declare implementation macro
 */
...
/**
 * @def CU_IMPL
 * @brief CUDA implementation macro
 */
 ...
 * @brief CUDA skip-GPU implementation macro
 */
 ...
 * @brief Composite operation macro (CUDA version)
 */
...
/**
 * @def COMPOSITE_OPERATION
 * @brief Composite operation macro (CPU version)
 */
#define COMPOSITE_OPERATION INLINE_IMPL(std::vector<System>)\
INLINE_IMPL(SparseState)
#endif
 ...
 * @brief CUDA condition arguments
 */
 ...
 * @brief CUDA condition parameter types
 */
 ...
 * @brief CUDA condition host-side preparation
 */
 ...
 * @brief CUDA condition lambda preparation
 */
 ...
 * @brief CUDA condition lambda captures
 */
 ...
 * @brief CUDA condition functor members
 */
 ...
 * @brief CUDA condition initialization
 */
